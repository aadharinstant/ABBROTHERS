...
$res = mysqli_query($conn, "SELECT * FROM `customers` WHERE status='pending' AND type='4' ORDER BY id ASC ");
if(isset($_POST['delete']) && $_POST['delete'] == "ahkwebsolutions"){
  ...
  window.location.href = "pendingworkdemoback2.php";
  }, 1500);
        </script>
        <?php
    }else{
                                    ...
                                    if(mysqli_num_rows($res)>0){
                                        ...
                                        while($data = mysqli_fetch_array($res)){
                                            ...
                                            <tr>
                                                ...
                                                <td>Old Gender == <?php echo $data['gender'] ?><?php if(!empty($data['gender'])){ echo '<br />New Gender ==  ' .$data['new_gender']; } ?></td>
