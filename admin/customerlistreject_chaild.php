...
$res = mysqli_query($conn, "SELECT * FROM `customers` WHERE appliedby='$s_phone' AND type='5' AND  status='reject' ORDER BY id DESC ");
if(isset($_POST['delete']) && $_POST['delete'] == "ahkwebsolutions"){
  ...
  window.location.href = "customerlistreject.php";
  }, 1500);
        </script>
        <?php
    }else{
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 20px;" class="text-center">Purpose</th>
                                         ...
                                         <th style="width: 20px;" class="text-center">Reson</th>
                                    ...
                                    if(mysqli_num_rows($res)>0){
                                        ...
                                        while($data = mysqli_fetch_array($res)){
                                            ...
                                            <td class="text-center"><?php echo $slno;?></td>
                                                ...
                                                <td class="text-center"><?php echo $data['reson'] ?></td>
