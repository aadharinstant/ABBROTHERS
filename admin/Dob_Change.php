...
if(isset($_POST['sub']) && $_POST['sub'] =="1"){
	...
	$newdob = mysqli_real_escape_string($conn,$_POST['new_dob']);
	...
	if($wallet3!=0){
        ...
        // ?End File Upload 
		$bal= $wallet3-1;
		$wres = mysqli_query($conn,"UPDATE usertable SET dob_wallet='$bal' WHERE phone='$username'");
		$res = mysqli_query($conn,"INSERT INTO `customers`(`type`, `parent`, `appliedby`, `memberemail`, `name`, `fname`, `dob`, `new_dob`, `aadhaar_no`, `mobile_no`, `email`, `purpose`, `finger1`, `finger2`, `finger3`, `finger4`, `finger5`, `status`,`poi`,`poa`,`pob`) VALUES ('$type','".$udata['userid']."','$username','".$udata['emailid']."','$name','$fname','$dob','$newdob','$aadhaar_no','$mobile_no','$email','$purpose','$photo1','$photo2','$photo3','$photo4','$photo5','$status','$link','$link2','$link3')");
		if($res){
            ?>
			<script>
            $(function(){
                                ...
                                <div class="card-title">
                                    <h4>Disclaimer :- It takes 24 hour to 48 hours for acknowledgement slip. Please be patient.</h4>
                                     <div style="display: flex; justify-content:flex-start">
                                        <a class="btn btn-dark" href="check.php" target="_blank">Available Balance : Rs <?php echo $wallet3['walletamount']; ?></a>
                                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="regform" method="post" enctype="multipart/form-data" class="form-horizontal"
							...
							<input name="type" type="hidden" value="3" required>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label for="date-input1">Father&Mother Name</label>
                                        <input type="text" name="dob" placeholder="Father&Mother Name"  class="form-control" required>
                                            
                                            
                                    </div>
                                    
                                     <div class="col-md-4">
                                        <label for="date-input1">Correct Dob</label>
                                        <input type="number" name="new_dob" placeholder="07/05/2000"  class="form-control" required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" id="Full Address" name="purpose" class="form-control" required>
                                    </div>
								   <script>
