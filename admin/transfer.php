...
$res = mysqli_query($conn, "SELECT * FROM usertable WHERE craeteby='".$_SESSION['phone']."'");


if(isset($_POST['sub']) && $_POST['sub'] =="1"){
	$wallet1 = mysqli_real_escape_string($conn,$_POST['number_wallet']);
	$wallet2 = mysqli_real_escape_string($conn,$_POST['name_wallet']);
	$wallet3 = mysqli_real_escape_string($conn,$_POST['dob_wallet']);
	$wallet4 = mysqli_real_escape_string($conn,$_POST['gender_wallet']);
	$wallet5 = mysqli_real_escape_string($conn,$_POST['child_wallet']);
	$email = mysqli_real_escape_string($conn,$_POST['emailid']);
	
	$ires = mysqli_query($conn,"UPDATE `usertable` SET `number_wallet`='$wallet1',`name_wallet`='$wallet2',`dob_wallet`='$wallet3',`gender_wallet`='$wallet4',`child_wallet`='$wallet5' WHERE emailid='$email' ");    
