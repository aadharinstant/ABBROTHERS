...
$res = mysqli_query($conn, "SELECT * FROM `customers` WHERE status='pending' AND type='6' ORDER BY id ASC ");
                                ...
                                <thead>
                                    ...
                                    <th style="width: 50px;" class="text-center">S/NO</th>
                                       ...
                                       <!-- <th class="text-center" style="width:30px;">DOB</th>-->
                                        ...
                                        <th style="width: 20px;" class="text-center">Address in Hindi</th>
                                        ...
                                        while($data = mysqli_fetch_array($res)){
                                            ...
                                            <tr>
                                               ...
                                               <!-- <td>Old - <?php echo $data['gender'] ?><?php if(!empty($data['gender'])){ echo '<br />New Gender - ' .$data['new_gender']; } ?></td>-->
                                                     ...
                                                     <!--<td class="text-center"> Old dob - <?php echo $data['dob'] ?><?php if(!empty($data['dob'])){ echo '<br />New DOB - ' .$data['new_dob']; } ?> -->
                                                </td>-->
