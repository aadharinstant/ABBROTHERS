...
$res = mysqli_query($conn, "SELECT * FROM `customers` WHERE appliedby='$s_phone' AND type='1' AND status='success' ORDER BY id ASC ");
                                    ...
                                    if(mysqli_num_rows($res)>0){
                                        ...
                                        while($data = mysqli_fetch_array($res)){
                                            ...
                                            <td class="text-center"><?php echo $slno ?></td>
                                                ...
                                                <td class="text-center"> <a href="viewreson.php?id=<?php echo base64_encode($data['id']) ?>" button class="btn btn-success"><?php echo $data['status'] ?></button></a>
                                                </td>
