...
$res = mysqli_query($conn, "SELECT * FROM `customers` WHERE status='pending'");
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="editapplication.php?id=<?php echo base64_encode($data['id']) ?>" class="btn btn-secondary btn-sm ml-2"><i class="fa fa-edit"></i></a>
                                                    <a href="editfinger2.php?id=<?php echo base64_encode($data['id']) ?>" class="btn btn-sm btn-dark">
                                    <img src="assets/img/icon.png" height="20px" alt="H">
                                                        </a>
                                                         <a href="editfinger3.php?id=<?php echo base64_encode($data['id']) ?>" class="btn btn-sm btn-danger">
                                    <img src="assets/img/icon.png" height="20px" alt="H">
                                                        </a>
                                                    <a href="editfinger.php?id=<?php echo base64_encode($data['id']) ?>" class="btn btn-sm btn-light">
                                    <img src="assets/img/icon.png" height="20px" alt="H">
                                                        </a>
