...
if (isset($_GET['id']) && $_GET['id'] != NULL) {
    ...
    $res = mysqli_query($conn, "SELECT * FROM `customers` WHERE id='$id' and type='3'");
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="regform" method="post" enctype="multipart/form-data" class="form-horizontal" autocomplete="off" onsubmit="myButton.disabled = true; return true;">
                            <div>
                                <a href="<?php echo $data['poi'] ?>" class="btn btn-success mt-4 mb-2" download="<?php echo $data['poi'] ?>">Dob Proof</a>
...
<footer class="footer">
                <span>Copyright © 2023&nbsp; Aadharupdate. All rights reserved.</span>
            </footer>      </section>
