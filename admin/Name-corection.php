...
if(isset($_POST['sub']) && $_POST['sub'] =="1"){
	...
	if($wallet2!=0){
        ...
        // ?End File Upload 
		$bal= $wallet2-1;
		$wres = mysqli_query($conn,"UPDATE usertable SET name_wallet='$bal' WHERE phone='$username'");
		$res = mysqli_query($conn,"INSERT INTO `customers`(`type`, `parent`, `appliedby`, `memberemail`, `name`, `new_name`, `fname`, `dob`, `aadhaar_no`, `mobile_no`, `email`, `purpose`, `finger1`, `finger2`, `finger3`, `finger4`, `finger5`, `status`,`poi`,`poa`,`pob`) VALUES ('$type','".$udata['userid']."','$username','".$udata['emailid']."','$name','$newname','$fname','$dob','$aadhaar_no','$mobile_no','$email','$purpose','$photo1','$photo2','$photo3','$photo4','$photo5','$status','$link','$link2','$link3')");
		if($res){
            ?>
			<script>
            $(function(){
...
<div class="main-container">
    <div class="pd-ltr-30 xs-pd-30-10">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="card-header bg-warning">
                            <div class="card-title ">
                                       <h3><strong>⚠ कृप्या ध्यान दे स्लिप लिमिट क्रॉस से रिजेक्ट होती है तो आप लोगों को ₹1 भी रिफंड नहीं किया जाएगा/जिनका फिंगर अपडेट हो उन्ही का एंट्री करे सिर्फ-: Thank you

                                <div class="card-title">
                                    <h4>Disclaimer :- It takes 24 hour to 48 hours for acknowledgement slip. Please be patient.</h4>
                                    <h4>Disclaimer :- Please Check The Customer's Aadhaar Number is Correct Or Incorrect.</h4> </B>
                                   <div style="display: flex; justify-content:flex-start">
                                        <a class="btn btn-dark" href="check.php" target="_blank">Available Balance : Rs <?php echo $wallet2['walletamount']; ?></a>
                                    </div>
                                    <div style="display: flex; justify-content:flex-end">
                                        <a class="btn btn-dark" href="democustomerlist.php"><i class="fa fa-check-circle"></i>View Name Curretion Update </a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-6 align-self-center text-right">
            <a href="democustomerlist.php" class="btn btn-success box-shadow btn-icon btn-rounded"><i class="fa fa-users"></i> View Customers</a>
        </div>
    </div>
    <section class="main-content">
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="regform" method="post" enctype="multipart/form-data" class="form-horizontal"
							...
							<input name="type" type="hidden" value="2" required>
                            <div class="form-group">
                                <div class="row">
                                  
                                    <div class="col-md-4">
                                        <label for="FullName">Old Name</label>
                                        <input type="text" placeholder="old name" id="fullname" name="name"
                                            class="form-control" required>
                                    </div>
                                     <div class="col-md-4">
                                        <label for="Purpose">NEW NAME HINDI + ENGLISH </label>
                                        <input type="text"placeholder=" new name hindi + english"purpose" name="purpose" class="form-control" required>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                     ...
                                     <div class="col-md-4">
                                        <label for="poa">Photo White background</label>
                                        <input type="file" id="poa" name="poa"   class="form-control" required>
                                        </div>
                                    <div class="col-md-4">
                                        <label for="poi">PAN CARD / DOMICILE CERTIFICATE</label>
                                        <input type="file" id="poi" name="poi"   class="form-control" required>
                                        </div>
                                </div>
                            </div>
