            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-default">
				        ...
				        <input type="text" class="form-control" disabled="disabled" id="reson" name="reson" placeholder="Enter Reseon" value="<?php echo $data['reson']?>" required>
				      </div>
                                     <div class="form-group col-md-3">
				        <label for="reson">Status</label>
				        <input type="text" class="form-control" disabled="disabled" id="reson" name="reson" placeholder="Enter Reseon" value="<?php echo $data['status']?>" required>
				      </div>
