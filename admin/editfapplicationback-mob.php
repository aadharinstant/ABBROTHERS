                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-default">
				        ...
				        <select class="form-control" id="reson" name="reson">
                                        ...
                                        <option <?php if($data['reson'] == 'Finger not clear'){ echo 'selected';} ?> value="Finger not clear">Finger Not Clear</option>
                                        <option <?php if($data['reson'] == 'finger not match'){ echo 'selected';} ?> value="Finger not match">Finger Not Match</option>
										<option <?php if($data['reson'] == 'Success'){ echo 'selected';} ?> value="Success">Success</option>
                                    </select>
				      </div>
