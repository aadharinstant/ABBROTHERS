...
$res = mysqli_query($conn, "SELECT * FROM `customers` WHERE status='pending' AND type='3' ORDER BY id ASC ");
        ...
        <div class="col-lg-6 align-self-center text-right">
            <a href="add-customer.php" class="btn btn-success box-shadow btn-icon btn-rounded"><i class="fa fa-plus"></i> Create New</a>
                    ...
                    <div class="card-header card-default">
                        View Customers Data - <?php echo $udata['dob'] ?> <?php echo $udata['usertype'] ?> </div>
                        <div class="card-body">
                                ...
                                <thead>
                                    ...
                                    <th  class="text-center">S/NO</th>
                                         <th class="text-center" style="width:80px;">Apply by</th>  <th class="text-center" style="width:80px;">Name</th>
                                       ...
                                       <!-- <th class="text-center" style="width:80px;">EMail Id</th> --->
                                        <th class="text-center" style="width:40px;">Father&Mother Name</th>
                                        <th class="text-center" style="width:30px;"> CORRECT DOB</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <!--  <td><?php echo $data['email'] ?></td> --->
                                                 ...
                                                 <td class="text-center"> <?php echo $data['new_dob'] ?>
                                                </td>
                                                <td class="text-center"> <?php echo $data['purpose'] ?>
                                                </td>
                                                <td class="text-center"> <a href="editapplicaiondob.php?id=<?php echo base64_encode($data['id']) ?>" button class="btn btn-warning"><?php echo $data['status'] ?></button></a>
                                                </td>
                                                <td class="text-center"><?php echo $data['date'] ?></td>
                                                <td class="text-center">


                                                   <a href="editapplicaiondob.php?id=<?php echo base64_encode($data['id']) ?>" class="btn btn-secondary btn-sm ml-2"><i class="fa fa-edit"></i></a>
                                                        </a>
                                    ...
                                    <img src="assets/img/icon.png" height="20px" alt="H">
                                                    ...
                                                    <a href="viewcustback2.php?id=<?php echo base64_encode($data['id']) ?>" class="btn btn-success btn-sm ml-2"><i class="fa fa-eye"></i></a>
