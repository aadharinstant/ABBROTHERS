...
if(isset($_POST['sub']) && $_POST['sub'] =="1"){
	...
	if($wallet4!=0){
        ...
        // ?End File Upload 
		$bal= $wallet4-1;
		$wres = mysqli_query($conn,"UPDATE usertable SET gender_wallet='$bal' WHERE phone='$username'");
		$res = mysqli_query($conn,"INSERT INTO `customers`(`type`, `parent`, `appliedby`, `memberemail`, `name`, `fname`, `gender`, `new_gender`, `aadhaar_no`, `mobile_no`, `email`, `purpose`, `finger1`, `finger2`, `finger3`, `finger4`, `finger5`, `status`,`poi`,`poa`,`pob`) VALUES ('$type','".$udata['userid']."','$username','".$udata['emailid']."','$name','$fname','$gender','$newgender','$aadhaar_no','$mobile_no','$email','$purpose','$photo1','$photo2','$photo3','$photo4','$photo5','$status','$link','$link2','$link3')");
		if($res){
            ?>
			<script>
            $(function(){
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="regform" method="post" enctype="multipart/form-data" class="form-horizontal"
							...
							<input name="type" type="hidden" value="4" required>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label for="date-input1">Old Gender</label>
                                        
                                                <input type="text" name="gender" placeholder="Old Gender"    class="form-control" required>
                                    ...
                                    <input type="hidden" name="sub" value="1">
                                    <div class="col-md-4">
                                        <label for="date-input1">New Gender</label>
                                        
                                                <input type="text" name="new_gender" placeholder="New Gender"   class="form-control" required>
