...
$res = mysqli_query($conn, "SELECT * FROM `customers` WHERE status='pending' AND type='5'");
if (isset($_POST['delete']) && $_POST['delete'] == "ahkwebsolutions") {
  ...
  window.location.href = "pendingwork_chaild2";
  }, 1500);
        </script>
    <?php
    } else {
                            ...
                            <div class="table-responsive">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" style="width:80px;">Child Name</th>
										<th class="text-center" style="width:80px;">Gender</th>
                                       	<th class="text-center" style="width:40px;">Guadian Name</th>
                                       	<th class="text-center">Guadian Aadhar No</th>
                                        <th class="text-center" style="width:30px;">Child Dob</th>
                                        <th class="text-center" style="width:80px;">Mobile Number</th>
                                        <th class="text-center" style="width:80px;">Address In english</th>
                                        <th class="text-center">Address In Hindi</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-center text-danger"> <h6 style="background:#36b9cc;margin:1px auto;width:max-content;padding:8px 10px;color:#fff;border-radius:4px"><?php echo $data['parent'] ?></h6> </td>
                                               
												<td><?php echo $data['name'] ?><br /><?php echo $data['new_name'] ?></td>
                                                ...
                                                <td class="text-center"> <a href="editapplicaionchild.php?id=<?php echo base64_encode($data['id']) ?>" button class="btn btn-warning"><?php echo $data['status'] ?></button></a> </td>
                                                <td class="text-center"><?php echo $data['date'] ?></td>
                                                <td class="text-center">


                                                    <a href="editapplicaionchild.php?id=<?php echo base64_encode($data['id']) ?>" class="btn btn-secondary btn-sm ml-2"><i class="fa fa-edit"></i>
                                    ...
                                    <img src="assets/img/icon.png" height="20px" alt="H">
                                                    ...
                                                    <a href="viewcustback4.php?id=<?php echo base64_encode($data['id']) ?>" class="btn btn-success btn-sm ml-2"><i class="fa fa-eye"></i></a>
