...
if(isset($_POST['sub']) && $_POST['sub'] =="1"){
	...
	$hname = mysqli_real_escape_string($conn,$_POST['new_name']);
	...
	if($wallet5!=0){
        ...
        if(isset($_FILES['poe']) ){
            $targetfolder = "uploads/";
            $targetfolder = $targetfolder .rand(00000,99999) . basename( $_FILES['poe']['name']) ;
           $file_type=$_FILES['poe']['type'];
           if ($file_type=="application/pdf" ) {
            if(move_uploaded_file($_FILES['poe']['tmp_name'], $targetfolder))
            {
                $link4 = $targetfolder;
        ...
        // ?End File Upload 
		$bal= $wallet5-1;
		$wres = mysqli_query($conn,"UPDATE usertable SET child_wallet='$bal' WHERE phone='$username'");
		$res = mysqli_query($conn,"INSERT INTO `customers`(`type`, `parent`, `appliedby`, `memberemail`, `name`, `new_name`, `fname`,`gender`, `dob`, `aadhaar_no`, `mobile_no`, `email`, `purpose`, `finger1`, `finger2`, `finger3`, `finger4`, `finger5`, `status`,`poi`,`poa`,`pob`,`poe`) VALUES ('$type','".$udata['userid']."','$username','".$udata['emailid']."','$name','$hname','$fname','$gender','$dob','$aadhaar_no','$mobile_no','$email','$purpose','$photo1','$photo2','$photo3','$photo4','$photo5','$status','$link','$link2','$link3','$link4')");
		if($res){
            ?>
			<script>
            $(function(){
  ...
  window.location.href = "customerlist_chaild.php";
  }, 1500);
        </script>
        <?php 
    }else{
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="regform" method="post" enctype="multipart/form-data" class="form-horizontal"
							...
							<input name="type" type="hidden" value="5" required>
                            <div class="form-group">
                                <div class="row">
                                  
                                    <div class="col-md-4">
                                        <label for="FullName">Child Name English/Hindi</label>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" name="gender">
                                            <option>Select Child Gender</option>
                                            <option>Male</option>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">                                        
									<label for="Aadhaar">Guardian Name</label>          
									<input id="fname-no" name="fname" type="text" class="form-control" required>                   
									</div>																
									<div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <label for="Purpose">Guardian Aadhar</label>
                                        <input type="number" name="aadhaar_no" class="form-control" required>
                                    </div>
                                    
                                    <div class="col-md-4">
                                        <label for="Purpose">Full Address</label>
                                    ...
                                    <div class="col-md-4">
                                        <label for="poi">Child Photo</label>
                                        <input type="file" id="poi"  name="poi" onchange="return fileValidation1()" class="form-control" >
                                    </div>
                                   <!--  <script>
                                    function fileValidation2(){
                                        var fileInput = document.getElementById('poa');
                                        var fileSize = (fileInput.files[0].size / 1024 / 1024).toFixed(2);
                                        if(fileSize > .3){
                                            alert("File size must be less than 300KB");
                                            fileInput.value = '';
                                    ...
                                    <div class="col-md-4">
                                        <label for="poa">Address Proof</label>
                                        <input type="file" id="poa" accept=".pdf" name="poa" onchange="return fileValidation2()" class="form-control" >
                                    </div> 
                                    <script>
                                    function fileValidation3(){
                                        var fileInput = document.getElementById('pob');
                                        var fileSize = (fileInput.files[0].size / 1024 / 1024).toFixed(2);
                                        if(fileSize > .3){
                                            alert("File size must be less than 300KB");
                                            fileInput.value = '';
                                    ...
                                    <div class="col-md-4">
                                        <label for="pob">Birth Certificate</label>
                                        <input type="file" id="pob" name="pob"  onchange="return fileValidation3()" class="form-control"  >
                                    </div>
                                    <!-- <script> 
                                    function fileValidation(){
                                        var fileInput = document.getElementById('poe');
                                        var fileSize = (fileInput.files[0].size / 1024 / 1024).toFixed(2);
                                        if(fileSize > .3){
                                            alert("File size must be less than 300KB");
                                            fileInput.value = '';
                                    ...
                                    <div class="col-md-4">
                                        <label for="poe">Enrollment Form</label>
                                        <input type="file" id="poe" name="poe" accept=".pdf" onchange="return fileValidation()" class="form-control"  >
                                    </div> -->
