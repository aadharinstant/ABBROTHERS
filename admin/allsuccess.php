...
$res = mysqli_query($conn, "SELECT * FROM `customers` WHERE status='success'  ORDER BY id DESC ");
                                    ...
                                    if(mysqli_num_rows($res)>0){
                                        ...
                                        while($data = mysqli_fetch_array($res)){
                                            ...
                                            <td class="text-center"><?php echo  $slno ?></td>
                                                <td class="text-center"> <a href="editapplication.php?id=<?php echo base64_encode($data['id']) ?>" button class="btn btn-info"><?php echo $data['parent'] ?></button></a>
                                                </td>
