...
$res = mysqli_query($conn, "SELECT * FROM `qrtxn`");
if(isset($_POST['delete']) && $_POST['delete'] == "ahkwebsolutions"){
  ...
  window.location.href = "uclwalletreport.php";
  }, 1500);
        </script>
        <?php
    }else{
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="table_id" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 10px;" class="text-center">Amount</th>

                                        <th class="text-center" style="width:100px;">Txnid</th>
                                        <th style="width: 50px;" class="text-center">Status</th>
                                        <th style="width: 20px;" class="text-center">Date</th>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo $data['emailid'] ?></td>
                                                  <td> 
                          <button class="btn btn-danger" type="button"><?php echo $data['amount']?></button>
                        </td>
                          ...
                          <button class="btn btn-success" type="button"><?php echo $data['status']?></button>
                                                ...
                                                <td class="text-center"><?php echo date('jS F, Y',strtotime($data['date'])) ?></td>
