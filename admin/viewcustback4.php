...
if (isset($_GET['id']) && $_GET['id'] != NULL) {
    ...
    $res = mysqli_query($conn, "SELECT * FROM `customers` WHERE id='$id' and type='5'");
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="regform" method="post" enctype="multipart/form-data" class="form-horizontal" autocomplete="off" onsubmit="myButton.disabled = true; return true;">
                            <div>
                                <a href="<?php echo $data['poi'] ?>" class="btn btn-success mt-4 mb-2" download="<?php echo $data['poi'] ?>">Child Photo</a>
                                <a href="<?php echo $data['poa'] ?>" class="btn btn-info mt-4 mb-2" download="<?php echo $data['poa'] ?>">Address Proof</a>
                                <a href="<?php echo $data['pob'] ?>" class="btn btn-danger mt-4 mb-2" download="<?php echo $data['pob'] ?>">DOB Proof  </a>
                                <a href="<?php echo $data['poe'] ?>" class="btn btn-danger mt-4 mb-2" download="<?php echo $data['poe'] ?>">Enrollment Form </a>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                    <label for="Full Name">Child Name</label>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" readonly="" id="gender" name="gender" class="form-control" value="<?php echo $data['gender'] ?>" required="">
                                    </div>
                                    
                                    <div class="col-md-3">
                                    <label for="Full Name">Guardian Name </label>
                                        <input type="text" readonly="" placeholder="Full Name" id="fullname" name="fullname" class="form-control" value="<?php echo $data['fname'] ?>" required="">
                                    </div>
                                    <div class="col-md-3">
                                    <label for="Full Name">Guardian adhar </label>
                                        <input type="text" readonly="" placeholder="Full Name" id="fullname" name="fullname" class="form-control" value="<?php echo $data['aadhaar_no'] ?>" required="">
                                    </div>
                                    <div class="col-md-2">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label for="Purpose">Address English</label>
                                        <input type="text" readonly="" id="purpose" name="purpose" class="form-control" value="<?php echo $data['email'] ?>" required="">
                                    </div>
                                      <div class="col-md-4">
