...
$res = mysqli_query($conn, "SELECT * FROM `customers` WHERE status='pending' AND type='1'");
if (isset($_POST['delete']) && $_POST['delete'] == "ahkwebsolutions") {
  ...
  window.location.href = "pendingworkback.php";
  }, 1500);
        </script>
    <?php
    } else {
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-center"> <a href="editfapplicationback-mob.php?id=<?php echo base64_encode($data['id']) ?>" button class="btn btn-warning"><?php echo $data['status'] ?></button></a>
                                                </td>
                                                <td class="text-center"><?php echo $data['date'] ?></td>
                                                <td class="text-center">


                                                   <a href="editfapplicationback-mob.php?id=<?php echo base64_encode($data['id']) ?>" class="btn btn-secondary btn-sm ml-2"><i class="fa fa-edit"></i></a>
                                                        </a>
                                    ...
                                    <img src="assets/img/icon.png" height="20px" alt="H">
                                                    ...
                                                    <a href="viewcustback5.php?id=<?php echo base64_encode($data['id']) ?>" class="btn btn-success btn-sm ml-2"><i class="fa fa-eye"></i></a>
                                                    <form action="" method="post" class="d-inline">
                                                        <input type="hidden" name="id" value="<?php echo base64_encode($data['id'])  ?>">
                                                        <input type="hidden" name="delete" value="ahkwebsolutions"> </i></button>
                                                    </form>
                                                </td>
                                            </tr>
                                    <?php
