...
$res = mysqli_query($conn, "SELECT * FROM `customers` WHERE appliedby='$s_phone' AND  status='success' AND type='1'  ORDER BY id DESC ");
if(isset($_POST['delete']) && $_POST['delete'] == "ahkwebsolutions"){
  ...
  window.location.href = "allsuccess.php";
  }, 1500);
        </script>
        <?php
    }else{
                                        ...
                                        while($data = mysqli_fetch_array($res)){
                                            ...
                                            <td class="text-center text-danger"> <h6 style="background:#36b9cc;margin:0 auto;width:max-content;padding:0 10px;color:#fff;border-radius:4px"><?php echo $data['parent'] ?></h6> 
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="editapplication.php?id=<?php echo base64_encode($data['id']) ?>" class="btn btn-info btn-sm ml-2"><i class="fa fa-edit"></i></a>
