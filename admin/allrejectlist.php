...
$res = mysqli_query($conn, "SELECT * FROM `customers` WHERE status='reject'  ORDER BY id DESC ");
if(isset($_POST['delete']) && $_POST['delete'] == "ahkwebsolutions"){
  ...
  window.location.href = "allrejectlist.php";
  }, 1500);
        </script>
        <?php
    }else{
                                    ...
                                    if(mysqli_num_rows($res)>0){
                                        ...
                                        while($data = mysqli_fetch_array($res)){
                                            ...
                                            <td class="text-center"><?php echo  $slno ?></td>
                                                 <td class="text-center text-danger"> <h6 style="background:#3355FF;margin:0 auto;width:max-content;padding:0 10px;color:#fff;border-radius:4px"><?php echo $data['parent'] ?></h6> 
                                                </td>
