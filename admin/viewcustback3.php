...
if (isset($_GET['id']) && $_GET['id'] != NULL) {
    ...
    $res = mysqli_query($conn, "SELECT * FROM `customers` WHERE id='$id' and type='4'");
                        ...
                        <form id="regform" method="post" enctype="multipart/form-data" class="form-horizontal" autocomplete="off" onsubmit="myButton.disabled = true; return true;">
                            <div>
                                ...
                                <a href="<?php echo $data['pob'] ?>" class="btn btn-danger mt-4 mb-2" download="<?php echo $data['pob'] ?>">DOB Proof  </a>
                                 <a href="<?php echo $data['pob'] ?>" class="btn btn-danger mt-4 mb-2" download="<?php echo $data['pob'] ?>">Enrollment Form </a>
                                <?php
                        ...
                        ?>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <label for="Full Name">Full Name</label>
                                        <input type="text" readonly="" placeholder="Full Name" id="fullname" name="fullname" class="form-control" value="<?php echo $data['new_name'] ?>" required="">
                                    </div>
                                    <div class="col-md-2">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label for="Purpose">Address HINDI</label>
