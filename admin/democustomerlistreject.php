...
$res = mysqli_query($conn, "SELECT * FROM `customers` WHERE  appliedby='$s_phone' AND status='reject' AND type='2' OR appliedby='$s_phone' AND status='reject' AND type='3' OR appliedby='$s_phone' AND status='reject' AND type='4' OR  appliedby='$s_phone' AND status='reject' AND type='6'");
if(isset($_POST['delete']) && $_POST['delete'] == "ahkwebsolutions"){
  ...
  window.location.href = "democustomerlistreject.php";
  }, 1500);
        </script>
        <?php
    }else{
                                    ...
                                    if(mysqli_num_rows($res)>0){
                                        ...
                                        while($data = mysqli_fetch_array($res)){
                                            ...
                                            <td class="text-center"><?php echo $slno;?></td>
                                                ...
                                                <td class="text-center"> <a href="viewreson.php?id=<?php echo base64_encode($data['id']) ?>" button class="btn btn-danger"><?php echo $data['status'] ?></button></a>
                                                </td>
