...
if (isset($_POST['ahkweb'])  && $_POST['ahkweb'] == "ahkwebsolutions") {
    ...
    $ires = mysqli_query($conn,"UPDATE `usertable` SET `name`='$name', `emailid`='$email', phone='$phone', `walletamount`='$walletamount',`state`='$state',`city`='$city',`userid`='$userid',`status`='$status', `usertype`='$usertype' WHERE userid='$id' ");    
                        ...
                        <form method="post" action="" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="userid" name="userid" placeholder="userid" value="<?php echo $data['userid'] ?>">
