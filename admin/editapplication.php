...
if(isset($_POST['ahkweb'])  && $_POST['ahkweb'] == "ahkwebsolutions") {
	...
	$czcz = mysqli_query($conn,"SELECT * from usertable  WHERE emailid='".$data['memberemail']."'");
	...
	$wallet7 = $zczzcz['address_wallet'];
	if($status=="reject"){
		if($data['type']==1){
			$bal =$wallet1+1;
			$ires = mysqli_query($conn,"UPDATE `usertable` SET `number_wallet`='$bal' WHERE emailid='".$data['memberemail']."' ");
		} elseif($data['type']==2){
			$bal =$wallet2+1;
			$ires = mysqli_query($conn,"UPDATE `usertable` SET `name_wallet`='$bal' WHERE emailid='".$data['memberemail']."' ");
		} elseif($data['type']==3){
			$bal =$wallet3+1;
			$ires = mysqli_query($conn,"UPDATE `usertable` SET `dob_wallet`='$bal' WHERE emailid='".$data['memberemail']."' ");
		} elseif($data['type']==4){
			$bal =$wallet4+1;
			$ires = mysqli_query($conn,"UPDATE `usertable` SET `gender_wallet`='$bal' WHERE emailid='".$data['memberemail']."' ");
		} elseif($data['type']==5){
			$bal =$wallet5+1;
			$ires = mysqli_query($conn,"UPDATE `usertable` SET `child_wallet`='$bal' WHERE emailid='".$data['memberemail']."' ");
		} 
		elseif($data['type']==6){
			$bal =$wallet7+1;
			$ires = mysqli_query($conn,"UPDATE `usertable` SET `address_wallet`='$bal' WHERE emailid='".$data['memberemail']."' ");
		} 
  ...
  window.location.href = "pendingwork.php";
  }, 1500);
        </script>
        <?php
    }else{
