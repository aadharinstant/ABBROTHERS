...
if (isset($_POST['reg']) && $_POST['reg'] == "ahkweb"  ) {
    ...
    if ($password == $password) {
      ...
      if (
        ...
        if (mysqli_num_rows($checksql) == 0) {
          ...
          $sql = "INSERT INTO `usertable` (`phone`, `emailid`, `name`,`psaid`,`cprize`, `password`, `city`, `state`, `userid`, `status`, `profilepic`, `createdby`, `joineddate`, `joinedtime`, `usertype`, `walletamount`,`otp`) VALUES ('$phone', '$email', '$name','NOT ALOTED', '98',  '$fpassword', 'cc', 'sdds', '$userid', 'verified', 'profile/admin.jpg', '$username1', '', '', '$usertype', '$walletamount','');";
  ...
  window.location.href = "duserlist.php";
  }, 1500);
